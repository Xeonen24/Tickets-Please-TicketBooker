      ...
      if (keyword === undefined) {
        ...
        switch (props.categorys) {
          case categorys.movies:
            break;
          default:
            response = await tmdbApi2.getMoviezList(movieType.now_playing, {
              params,
            });
        }
      } else {
    ...
    if (keyword === undefined) {
      ...
      switch (props.categorys) {
        case categorys.movies:
          break;
        default:
          response = await tmdbApi2.getMoviezList(movieType.popular, {
            params,
          });
      }
    } else {
    ...
    <>
      ...
      {page < totalPage ? (
        <div className="movie-grid__loadmore">
          <a className="green_btns2" onClick={loadMore}>
            Load more
          </a>
        </div>
      ) : null}
