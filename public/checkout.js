  ...
  (i.n = function (e) {
    ...
    (function () {
      ...
      var Q,
        ...
        de = {
          default: { decimals: 2, format: se.three, minimum: 100 },
          ...
          ANG: { minor: "cent" },
          AOA: { minor: "lwei" },
          ARS: { format: se.threecommadecimal, minor: "centavo", minimum: 80 },
          AUD: { format: se.threespaceseparator, minimum: 50, minor: "cent" },
          ...
          BRL: { format: se.threecommadecimal, minimum: 50, minor: "centavo" },
          ...
          CDF: { minor: "centime" },
          CHF: { format: se.chf, minimum: 50, minor: "rappen" },
          CLP: {
            decimals: 0,
            format: se.none,
            major: "peso",
          ...
          COP: { format: se.threecommadecimal, minor: "centavo", minimum: 1e3 },
          CRC: { format: se.threecommadecimal, minor: "centimo", minimum: 1e3 },
          CUC: { minor: "centavo" },
          CUP: { minor: "centavo", minimum: 53 },
          CVE: { minor: "centavo" },
          CZK: { format: se.threecommadecimal, minor: "haler", minimum: 46 },
          ...
          HRK: { format: se.threecommadecimal, minor: "lipa", minimum: 14 },
          HTG: { minor: "centime", minimum: 167 },
          HUF: { decimals: 0, format: se.none, major: "forint", minimum: 555 },
          IDR: { format: se.threecommadecimal, minor: "sen", minimum: 1e3 },
          ILS: { minor: "agorot", minimum: 10 },
          INR: { format: se.inr, minor: "paise" },
          ...
          LTL: { format: se.threespacecommadecimal, minor: "centu" },
          LVL: { minor: "santim" },
          ...
          MYR: { format: se.myr, minor: "sen", minimum: 10 },
          MZN: { decimals: 0, major: "metical" },
          NAD: { minor: "cent", minimum: 29 },
          NGN: { minor: "kobo", minimum: 723 },
          NIO: { minor: "centavo", minimum: 66 },
          NOK: { format: se.threecommadecimal, minimum: 300, minor: "Ã¸re" },
          ...
          PLN: { format: se.threespacecommadecimal, minor: "grosz" },
          PYG: { decimals: 0, major: "guarani", minor: "centimo" },
          QAR: { minor: "dirham", minimum: 10 },
          RON: { format: se.threecommadecimal, minor: "bani" },
          RUB: { format: se.threecommadecimal, minor: "kopeck", minimum: 130 },
          ...
          SYP: { minor: "piaster" },
          SZL: { format: se.szl, minor: "cent", minimum: 29 },
          ...
          UAH: { format: se.threespacecommadecimal, minor: "kopiyka" },
          UGX: { minor: "cent" },
          USD: { minimum: 50, minor: "cent" },
          UYU: { format: se.threecommadecimal, minor: "centÃ©", minimum: 67 },
          UZS: { minor: "tiyin", minimum: 1e3 },
          VND: { format: se.none, minor: "hao,xu" },
          ...
          ZAR: { format: se.threespaceseparator, minor: "cent", minimum: 29 },
          ZMK: { minor: "ngwee" },
        },
        me = function (e) {
      ...
      (X = {}),
        oe((Q = ie), function (e, n) {
          (ie[n] = e),
            ...
            Q[n].denomination &&
              (de[n].decimals = Math.LOG10E * Math.log(Q[n].denomination)),
            (X[n] = Q[n].symbol);
        }),
        Object.assign(fe, X),
        he(X),
      ...
      function ge(e, n) {
        return e
          ? 0 === e.indexOf("experiments.") && void 0 !== ye(e)
            ? ye(e)
            : J(H.preferences, e, n)
          : H.preferences;
      }
      ...
      H.set, H.getMerchantOption, H.isIRCTC, H.getCardFeatures;
      be("callback_url");
      var Oe = function () {
      ...
      be("prefill.name"), be("prefill.card[number]"), be("prefill.vpa");
      var xe,
        Se = function () {
      ...
      var Je = function (e) {
        ...
        Xe =
          (Ce(/(Vivo|HeyTap|Realme|Oppo)Browser/),
          function () {
            return Te
              ? "iPhone"
              : Ne
      ...
      var Tn,
        ...
        Hn = nn(
          zn(function (e, n) {
            ...
            return t ? n.insertBefore(e, t) : Un(e, n), e;
          })
        ),
        Yn =
          (nn(
        ...
        qn =
          (nn(
            Kn(function (e, n) {
              return Vn(e, n) ? Jn(e, n) : Wn(e, n), e;
            })
          ),
          tn(
            Kn(function (e, n, t) {
              return t ? Wn(e, n) : Jn(e, n), e;
            })
          ),
          nn(
            Kn(function (e, n) {
        ...
        rt = (tt("none"), tt("block"), tt("inline-block"), _n("offsetWidth")),
        ot = _n("offsetHeight"),
        at =
          (Bn(function (e) {
          ...
          if (!yn(e, Nn))
            return function (o) {
              ...
              return (
                ln(t)
                  ? (a = function (e) {
                      for (var r = e.target; !ct(r, t) && r !== o; ) r = $n(r);
        ...
        if (q(o))
          for (var a in o)
            if (o.hasOwnProperty(a)) {
              var i = St({ doc: t, name: a, value: o[a] });
              r.appendChild(i);
            }
      }
      function St(e) {
        ...
        (bt.jsonp = gt.bind(function (e) {
          ...
          return (
            ...
            (r.call = function () {
              ...
              u = Dn((u = yt(u, In)), An({ callback: "Razorpay.".concat(o) }));
              var s = Ln("script");
              Object.assign(s, {
                src: u,
                async: !0,
      ...
      var kt,
        Rt,
        At = document.body,
        Ct = (i.g.innerWidth, i.g.innerHeight),
        Dt = i.g.pageYOffset,
        jt = window.scrollBy,
        Tt = window.scrollTo,
        Mt = window.requestAnimationFrame,
        It = document.querySelector.bind(document),
      ...
      function zt(e) {
        !(function (e) {
          if (!i.g.requestAnimationFrame) return jt(0, e);
          Rt && clearTimeout(Rt);
          Rt = setTimeout(function () {
            ...
            function a(i) {
              if ((r += (i - o) / 300) >= 1) return Tt(0, t);
              var c = Math.sin((Kt * r) / 2);
              Tt(0, n + Math.round(e * c)), (o = i), Mt(a);
            }
            Mt(a);
          }, 100);
        })(e - Dt);
      ...
      var Gt = Ft,
        Ut =
          ...
          i.g !== i.g.parent),
        Zt = Ut ? i.g.parent : i.g.opener,
        Ht = 4478611435,
        Yt = "canary",
        Vt = "3b28a787e01f62916e862f4566f43d2092753d66";
      ...
      var Wt = (function () {
          try {
            ...
            return (
              Ut &&
                ((n = Gt.frameApi), ((kt = Ln("a")).href = n), (e = kt.href)),
      ...
      _(Qt, "subscriptions", {}),
        ...
        window.addEventListener("message", function (e) {
          ...
          r &&
            Qt.subscriptions[r] &&
            Qt.subscriptions[r].forEach(function (e) {
              e(o);
            });
        });
      var Xt = Qt;
      ...
      function cr(e, n) {
        var t = (function (e) {
            return e === er
              ? "checkout."
                  .concat(or, ".sessionCreated.metrics")
                  .replace(".production", "")
              : "checkout."
                  .concat(or, ".sessionErrored.metrics")
                  .replace(".production", "");
          })(e),
        ...
        if (
          ...
          try {
            t
              ...
              (function (e, n) {
                Ut
                  ? Xt.publishToParent("syncAvailability", {
                      sessionCreated: e,
                      sessionErrored: n,
                    })
      ...
      function vr(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? _r(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : _r(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
      ...
      function br(e) {
        for (var n = ""; e; ) (n = gr[e % 62] + n), (e = wn(e / 62));
        return n;
      }
      function Or() {
        var e,
          n =
            br(
              +(
                String(bn() - 13885344e5) +
                String("000000".concat(wn(1e6 * On()))).slice(-6)
              )
            ) +
            br(wn(238328 * On())) +
            "0",
      ...
      var Rr,
        ...
        Mr = function (e) {
          if ((e && (Rr = e), Cr.length && "live" === Rr)) {
            Cr.forEach(function (e) {
              ("open" === e.event ||
                ("submit" === e.event && "razorpayjs" === Ir.props.library)) &&
                lr("session_created");
            });
        ...
        e
          ? "test" !== (Rr = e.getMode()) &&
            setTimeout(function () {
              ...
              jr({ event: n, properties: c, timestamp: bn() }),
                Tr(o),
                r && Mr();
            })
          : Dr.push([n, t, r]);
      ...
      function Lr(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? Nr(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : Nr(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
      ...
      var Br,
        ...
        Wr = {
          setR: function (e) {
            (Br = e), Ir.dispatchPendingEvents(e);
          },
          track: function (e) {
            var n =
                arguments.length > 1 && void 0 !== arguments[1]
            ...
            try {
              ...
              Ir(
                i,
                Ur.JS_ERROR,
                { data: { error: $r(e, { severity: Fr, unhandled: !1 }) } },
                !0
              );
            }
          },
      ...
      function To(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? jo(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : jo(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
          ...
          return (
            I(e, [
              ...
              },
              {
                key: "reset",
                value: function () {
                  this.setAnonymousId(No()), this.setUserId("");
                },
              },
              {
                key: "getState",
      ...
      function Ho(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? Zo(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : Zo(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
      ...
      var Vo,
        ...
        Jo,
        qo = "checkout.id",
        Qo = "checkout.referrerType",
        Xo = "checkout.integration.name",
        ea = "checkout.integration.type",
        na = "checkout.integration.version",
        ta = "checkout.integration.parentVersion",
        ra = "checkout.integration.platform",
        oa = "checkout.library",
        aa = "checkout.mode",
        ia = "checkout.order.id",
        ca = "checkout.version",
        la = "traits.contact",
        ua = "traits.email",
        sa = "referrer",
        ...
        ma = Wt ? "2Fle0rY1hHoLCMetOdzYFs1RIJF" : "27TM2uVMCl4nm4d7gqR4tysvdU1";
      function pa(e, n) {
        var t = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
              ...
              fa(
                ...
                (ya = !0),
                {
                  ...
                  identify: function (e) {
                    ...
                    })({ url: _a, key: va, payload: e }).catch(Uo);
                  },
                  loaded: function () {
                    return !0;
                  },
      ...
      Xt.subscribe("syncContext", function (e) {
        ...
        Xt.subscribe("syncAnonymousId", function (e) {
          ...
          null !== (n = e.data) &&
            void 0 !== n &&
            n.anonymousId &&
            ba.setAnonymousId(e.data.anonymousId);
        }),
      ...
      function xa(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? wa(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : wa(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
      ...
      function Sa(e, n) {
        Ut
          ? Xt.publishToParent("syncContext", { key: e, value: n })
          : Xt.sendMessage("syncContext", { key: e, value: n });
      }
      var Ea = {};
      function Pa(e, n, t, r) {
        return function () {
          if (!t) {
            var o = e[n],
              a = (arguments.length <= 0 ? void 0 : arguments[0])
                ? xa(
                    xa({}, arguments.length <= 0 ? void 0 : arguments[0]),
                    {},
                    { funnel: r }
                  )
                : { funnel: r },
      ...
      var Ra = {
          setContext: function (e, n) {
            var t =
              !(arguments.length > 2 && void 0 !== arguments[2]) ||
              arguments[2];
            Oa.setContext(e, n), t && Sa(e, n);
          },
          getState: function () {
            return xa(xa({}, Oa.getState()), {}, { last: Ea });
          },
      ...
      _(Aa, "selectedBlock", {}),
        _(Aa, "selectedInstrumentForPayment", { method: {}, instrument: {} }),
      ...
      var Ca = ka({ TRIGGERED: { name: "triggered", type: j } });
      function Da(e, n) {
        var t = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Ta = function (e, n) {
        ...
        try {
          var c,
            ...
            m = void 0 === d || d,
            p = !1;
          if (("razorpayjs" !== Ir.props.library && !Wt) || Ge) return;
          (function (e) {
            try {
              var n = ln(e)
                ? e
          ...
          var f = "string" == typeof u ? u : Ur.JS_ERROR;
          (o !== zr && o !== Kr) || lr("session_errored", o);
          var h = $r(e, { severity: o, unhandled: i, ignored: p });
          Eo.track(f, {
            data: ja(ja({}, "object" === E(s) ? s : {}), {}, { error: h }),
            ...
            Ca.TRIGGERED({
              error: h,
              last:
                null === (c = Ra.getState()) || void 0 === c ? void 0 : c.last,
            });
        } catch (e) {}
      };
      function Ma() {
      ...
      (Ka = "#949494"),
        '<svg viewBox="0 0 21 24" xmlns="http://www.w3.org/2000/svg">\n     <path d="M9.516 20.254l9.15-8.388-6.1-8.388-1.185 6.516 1.629 2.042-2.359 1.974-1.135 6.244zM12.809.412l8 11a1 1 0 0 1-.133 1.325l-12 11c-.707.648-1.831.027-1.66-.916l1.42-7.805 3.547-3.01-1.986-5.579 1.02-5.606c.157-.865 1.274-1.12 1.792-.41z" fill="'
          ...
          .concat(Ka, '"/>\n  </svg>');
      var Ka,
        Fa = "com.google.android.apps.nbu.paisa.user";
      var Ga = function (e) {
        var n =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          t = re(e);
        ...
        !t.key_id && r && (t.key_id = r),
          ...
          (n.tez || n.gpay) &&
            ((t["_[flow]"] = "intent"), t["_[app]"] || (t["_[app]"] = Fa)),
      ...
      function Ua() {
        var e =
          ...
          t = ""
            .concat(Gt.api)
            .concat(Gt.version, "standard_checkout/")
            .concat(e);
        return Et(t, { session_token: n });
      }
      function Za() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
        ...
        return t && i.g.session_token && n
          ? Ua(e, i.g.session_token)
          : "".concat(Gt.api).concat(Gt.version).concat(e);
      }
      var Ha = {
        AF: {
          pattern: "^[0-9]{4}$",
      ...
      Object.keys(Ha).reduce(function (e, n) {
        return (e[n] = Ha[n].dial_code), e;
      }, {}),
        Object.keys(Ha).reduce(function (e, n) {
          return (e[n] = n), e;
        }, {});
      ...
      function qa(e) {
        return {
          "_[agent][platform]": (J(
            ...
            ? { platform: "ios" }
            : {
                platform: Ja.platform || "web",
                library: "checkoutjs",
                version: (Ja.version || Ht) + "",
              }
          ).platform,
          "_[agent][device]":
            null != e && e.cred
      ...
      function Xa(e) {
        for (var n = 1; n < arguments.length; n++) {
          var t = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? Qa(Object(t), !0).forEach(function (n) {
                _(e, n, t[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
            : Qa(Object(t)).forEach(function (n) {
                Object.defineProperty(
                  e,
                  n,
                  Object.getOwnPropertyDescriptor(t, n)
      ...
      var ei = {
          RETRY_BUTTON: { name: "retry_button", type: k },
          RETRY_CLICKED: { name: "retry_clicked", type: P },
          AFTER_RETRY_SCREEN: { name: "after_retry_screen", type: k },
          RETRY_VANISHED: { name: "retry_vanished", type: P },
          PAYMENT_CANCELLED: { name: "payment_cancelled", type: P },
        },
        ni = {
          P13N_CALL_INITIATED: { name: "p13n_call_initiated", type: D },
          P13N_CALL_RESPONSE: { name: "p13n_call_response", type: D },
          P13N_CALL_FAILED: { name: "p13n_call_failed", type: D },
          P13N_LOCAL_STORAGE_RESPONSE: {
            name: "p13n_local_storage_response",
            type: D,
          },
          P13N_METHOD_SHOWN: { name: "p13n_methods_shown", type: k },
        },
        ti = ka(
          {
            OPEN: { name: "checkout_open", type: k },
            INVOKED: { name: "checkout_invoked", type: C },
            CONTACT_NUMBER_FILLED: { name: "contact_number_filled", type: P },
            EMAIL_FILLED: { name: "email_filled", type: P },
            CONTACT_DETAILS: { name: "contact_details", type: k },
            ...
            METHOD_SELECTED: { name: "Method:selected", type: P },
            INSTRUMENT_SELECTED: { name: "instrument:selected", type: P },
            USER_LOGGED_IN: { name: "user_logged_in", type: P },
            COMPLETE: { name: "complete", type: k },
          },
          { funnel: Jo.HIGH_LEVEL }
        ),
        ri =
          (ka(ei, { skipEvents: !0, funnel: Jo.RETRY }),
          ka(ni, { skipEvents: !0, funnel: Jo.P13N_ALGO }));
      function oi(e) {
        var n,
          t = this;
        if (!yn(this, oi)) return new oi(e);
        Ma.call(this),
          (this.id = Ir.makeUid()),
      ...
      oi.sendMessage = function (e) {
        throw new Error("override missing for event - ".concat(e.event));
      };
      var ai = (oi.prototype = new Ma());
      function ii(e, n) {
        return bt.jsonp({
          url: Va(qt),
          data: e,
          callback: function (e) {
            (en.preferenceResponse = e), n(e);
          },
        });
      }
      function ci(e) {
        if (e) {
          ...
          var t = { library: Ir.props.library, platform: Ir.props.platform };
          return (function (e, n, t) {
            var r = {},
              o = n.key;
            o && (r.key_id = o);
      ...
      (ai.postInit = Uo),
        (ai.onNew = function (e, n) {
          var t = this;
          "ready" === e &&
            (this.prefs
              ? n(e, this.prefs)
              : ii(ci(this), function (e) {
                  e.methods && ((t.prefs = e), (t.methods = e.methods)),
                    n(t.prefs, e);
                }));
        }),
        (ai.emi_calculator = function (e, n) {
          return oi.emi.calculator(this.get("amount") / 100, e, n);
        }),
        (oi.emi = {
        ...
        (oi.payment = {
          getMethods: function (e) {
            return ii({ key_id: oi.defaults.key }, function (n) {
              e(n.methods || n);
            });
          },
          getPrefs: function (e, n) {
            var t = xn();
            return (
              Eo.track("prefs:start", { type: R }),
              ri.P13N_CALL_INITIATED({ api: qt }),
              q(e) && (e["_[request_index]"] = Eo.updateRequestIndex(qt)),
              bt({
                url: Dn(Va(qt), e),
                callback: function (r) {
                  if (
                    (Eo.track("prefs:end", { type: R, data: { time: t() } }),
                    200 !== (null == r ? void 0 : r.status_code) &&
                      ri.P13N_CALL_FAILED({ api: qt }),
          ...
          getRewards: function (e, n) {
            var t = xn();
            return (
              Eo.track("rewards:start", { type: R }),
              bt({
                url: Dn(Va("checkout/rewards"), e),
                callback: function (e) {
                  Eo.track("rewards:end", { type: R, data: { time: t() } }),
                    n(e);
                },
              })
            );
        ...
        (ai.calculateFees = function (e) {
          var n = this;
          return new Promise(function (t, r) {
            (e = Ga(e, n)),
              bt.post({
                url: Va("payments/calculate/fees"),
                data: e,
                callback: function (e) {
        ...
        (ai.fetchVirtualAccount = function (e) {
          var n = e.customer_id,
            t = e.order_id,
            r = e.notes;
      ...
      function vi(e) {
        ...
        return (
          (vi = function (e) {
            ...
            function r() {
              return _i(e, arguments, fi(this).constructor);
            }
            return (
      ...
      (oi.configure = function (e) {
        ...
        oe($a(e, Ia), function (e, n) {
          ...
          n.library &&
            ((Ir.props.library = n.library), Ra.setContext(oa, n.library)),
          n.referer &&
            ((Ir.props.referer = n.referer), Ra.setContext(sa, n.referer));
      }),
        (oi.defaults = Ia),
        (oi.enableLite = Boolean(Gt.merchant_key)),
        (i.g.Razorpay = oi),
        (Ia.timeout = 0),
        (Ia.name = ""),
        (Ia.partnership_logo = ""),
        ...
        (Ia.features = { cardsaving: !0, truecaller_login: null }),
        (Ia.readonly = { contact: !1, email: !1, name: !1 }),
        (Ia.hidden = { contact: !1, email: !1 }),
        (Ia.modal = {
          confirm_close: !1,
          ondismiss: Uo,
          onhidden: Uo,
        ...
        (Ia.external = { wallets: [], handler: Uo }),
        (Ia.challan = { fields: [], disclaimers: [], expiry: {} }),
        (Ia.theme = {
          upi_only: !1,
          color: "",
      ...
      function yi() {
        (function (e) {
          ...
          (function (e) {
            ...
            So.TrackMetric("inter_font_load_failure", { data: { error: e } });
          });
      }
      var bi = {
      ...
      function Ti(e, n, t, r) {
        return e[1] && r ? Pi(t.ctx.slice(), e[1](r(n))) : t.ctx;
      }
      function Mi(e, n, t, r) {
        if (e[2] && r) {
          var o = e[2](r(t));
      ...
      function dc() {
        if (!uc) {
          uc = !0;
          do {
            for (var e = 0; e < nc.length; e += 1) {
              var n = nc[e];
              Xi(n), mc(n.$$);
            }
            for (Xi(null), nc.length = 0; tc.length; ) tc.pop()();
            for (var t = 0; t < rc.length; t += 1) {
              var r = rc[t];
              sc.has(r) || (sc.add(r), r());
            }
            rc.length = 0;
      ...
      function mc(e) {
        if (null !== e.fragment) {
          e.update(), Ai(e.before_update);
          var n = e.dirty;
          (e.dirty = [-1]),
            e.fragment && e.fragment.p(e.ctx, n),
            e.after_update.forEach(lc);
        }
      }
      var pc,
        fc = new Set();
      ...
      function _c() {
        pc.r || Ai(pc.c), (pc = pc.p);
      }
      function vc(e, n) {
        e && e.i && (fc.delete(e), e.i(n));
      }
      function gc(e, n, t, r) {
        if (e && e.o) {
          if (fc.has(e)) return;
        ...
        a && a.m(n, t),
          r ||
            lc(function () {
              ...
              c ? c.push.apply(c, xi(n)) : Ai(n), (e.$$.on_mount = []);
            }),
          l.forEach(lc);
      }
      function Oc(e, n) {
      ...
      function wc(e, n) {
        -1 === e.$$.dirty[0] && (nc.push(e), cc(), e.$$.dirty.fill(0)),
      ...
      function xc(e, n, t, r, o, a, i) {
        ...
        if (
          ...
          if (n.hydrate) {
            Li();
            var d = Vi(n.target);
            u.fragment && u.fragment.l(d), d.forEach(Ki);
          } else u.fragment && u.fragment.c();
          n.intro && vc(e.$$.fragment),
            bc(e, n.target, n.anchor, n.customElement),
            $i(),
            dc();
        }
        Xi(l);
        ...
        return {
          c: function () {
            (n = Fi("button")),
              ...
              Yi(t, "width", "12"),
              Yi(t, "height", "15"),
              Yi(t, "viewBox", "0 0 12 15"),
              Yi(t, "fill", "none"),
              Yi(t, "xmlns", "http://www.w3.org/2000/svg"),
              Yi(t, "class", "icon"),
              Yi(n, "id", "razorpay-magic-btn"),
              Ji(n, "width", e[2]),
              Ji(n, "border-radius", e[3]),
              Ji(n, "background", e[4]),
              Yi(n, "data-testid", "razorpay-magic-btn"),
              Yi(n, "data-variant", "razorpay-magic-btn");
          },
          m: function (u, s) {
            zi(u, n, s),
              Bi(n, t),
          ...
          p: function (t, r) {
            ...
            (e = t),
              ...
              (!i || 4 & o) && Ji(n, "width", e[2]),
              (!i || 8 & o) && Ji(n, "border-radius", e[3]),
              (!i || 16 & o) && Ji(n, "background", e[4]);
          },
          i: function (e) {
            i || (vc(d, e), (i = !0));
          },
      ...
      var Cc = (function (e) {
        ...
        function t(e) {
          ...
          return (
            T(this, t),
            xc(mi((r = n.call(this))), e, Ac, Rc, Di, {
              handleClick: 0,
              btnText: 1,
              width: 2,
              borderRadius: 3,
        ...
        return {
          c: function () {
            (n = Gi("svg")),
              ...
              Yi(t, "fill", "#3395FF"),
              Yi(r, "d", "M1.6 14.95 0 20.9h7.88l3.23-12.1-9.52 6.15Z"),
              Yi(r, "fill", "#fff"),
              Yi(n, "width", "19"),
              Yi(n, "height", "21"),
              Yi(n, "fill", "none"),
              Yi(n, "xmlns", "http://www.w3.org/2000/svg");
          },
          m: function (e, o) {
            zi(e, n, o), Bi(n, t), Bi(n, r);
          },
          d: function (e) {
            e && Ki(n);
          },
      ...
      function Ic(e) {
        ...
        return {
          c: function () {
            ((n = Fi("span")).textContent = "All payment methods supported"),
              Yi(n, "class", "sub");
          },
          m: function (e, t) {
            zi(e, n, t);
        ...
        return {
          c: function () {
            (n = Fi("button")),
              ...
              Yi(a, "class", "buy"),
              Ji(a, "font-size", e[7] + "px"),
              Yi(o, "class", "title"),
              Ji(t, "display", "flex"),
              Ji(t, "gap", "8px"),
              Ji(t, "align-items", "center"),
              Yi(n, "id", "razorpay-magic-btn"),
              Ji(n, "width", e[1]),
              Ji(n, "border-radius", e[2]),
              Ji(n, "position", "relative"),
              Ji(n, "padding", "12px " + e[8] + "px"),
              Yi(n, "data-testid", "magic-btn-v1"),
              Yi(n, "data-variant", "magic-btn-v1"),
              Ji(s, "text-align", "center");
          },
          m: function (_, v) {
            var g;
            zi(_, n, v),
          ...
          p: function (c, l) {
            ...
            (e = c)[4]
              ...
              e[3]
                ...
                : h && (h.d(1), (h = null)),
              2 & u && Ji(n, "width", e[1]),
              4 & u && Ji(n, "border-radius", e[2]),
              256 & u && Ji(n, "padding", "12px " + e[8] + "px");
          },
          i: Ei,
          o: Ei,
          d: function (e) {
      ...
      function Fc(e) {
        var n,
          ...
          a = e[0];
        function i(e) {
          for (var n = {}, t = 0; t < o.length; t += 1) n = Pi(n, o[t]);
          return { props: n };
        }
        return (
          a && (n = new a(i())),
          {
            c: function () {
              n && yc(n.$$.fragment), (t = Ui(""));
            },
            m: function (e, o) {
              n && bc(n, e, o), zi(e, t, o), (r = !0);
            },
            p: function (e, r) {
              var c,
                l =
              ...
              if (a !== (a = e[0])) {
                if (n) {
                  hc();
                  var u = n;
                  gc(u.$$.fragment, 1, 0, function () {
                    Oc(u, 1);
                  }),
                    _c();
                }
                a
                  ? (yc((n = new a(i())).$$.fragment),
                    vc(n.$$.fragment, 1),
                    bc(n, t.parentNode, t))
                  : (n = null);
              } else a && n.$set(l);
            ...
            i: function (e) {
              r || (n && vc(n.$$.fragment, e), (r = !0));
            },
            o: function (e) {
              n && gc(n.$$.fragment, e), (r = !1);
            },
            d: function (e) {
              e && Ki(t), n && Oc(n, e);
            },
        ...
        function x(e) {
          try {
            So.setMeta("position", y),
              So.TrackBehav(yo.BRANDED_BUTTON_CLICKED, { variant: v });
          } catch (e) {}
          b("click", e);
        }
        return (
          (cc(), ac).then(function () {
            return So.TrackIntegration(
              "magic_btn_props",
              (function (e) {
                for (var n = 1; n < arguments.length; n++) {
                  var t = null != arguments[n] ? arguments[n] : {};
                  n % 2
                    ? Kc(Object(t), !0).forEach(function (n) {
                        _(e, n, t[n]);
                      })
                    : Object.getOwnPropertyDescriptors
                    ...
                    : Kc(Object(t)).forEach(function (n) {
                        Object.defineProperty(
                          e,
                          n,
                          Object.getOwnPropertyDescriptor(t, n)
          ...
          (e.$$.update = function () {
            ...
            if (748 & e.$$.dirty)
              if ("v1" === v)
                t(0, (O = Bc)),
                  t(1, (w = { handleClick: x, width: i, borderRadius: l }));
              else
                t(0, (O = Cc)),
                  t(
                    1,
      ...
      var Uc = (function (e) {
        ...
        function t(e) {
          ...
          return (
            T(this, t),
            xc(mi((r = n.call(this))), e, Gc, Fc, Di, {
              width: 2,
              borderRadius: 3,
              pageType: 4,
              bgColor: 5,
      ...
      if (
        ...
        var Yc = (function (e) {
          ...
          function t() {
            ...
            return (
              ...
              (e._rzp = null),
              yi(),
              e._root.appendChild(Hc.content.cloneNode(!0)),
              (e._button = new Uc({ target: e._root })),
              e
            );
          }
          return (
        ...
        window.customElements.get("magic-checkout-btn") ||
          window.customElements.define("magic-checkout-btn", Yc);
      }
      var Vc,
        Wc = "page_view",
        Jc = "payment_successful",
        qc = "payment_failed",
        Qc = "pay_now_clicked",
        Xc = "rzp_payments";
      function el(e, n) {
      ...
      function rl(e) {
        we() &&
          ((ge("features.one_cc_ga_analytics") || ye("enable_ga_analytics")) &&
            oi.sendMessage({ event: "gaevent", data: e }),
          (ge("features.one_cc_fb_analytics") || ye("enable_fb_analytics")) &&
            oi.sendMessage({ event: "fbaevent", data: e }));
      }
      function ol(e, n) {
        var t = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
      ...
      var al,
        ...
        pl = {
          ...
          orientationchange: function () {
            pl.resize.call(this), pl.scroll.call(this);
          },
          resize: function () {
            var e = i.g.innerHeight || sl.height;
            (vl.container.style.position = e < 450 ? "absolute" : "fixed"),
      ...
      function hl(e) {
        ...
        return (
          (n = Dn(n, { traffic_env: Yt, build: Vt })),
          oi.enableLite &&
            (n = Dn(n, {
              merchant_key: Gt.merchant_key,
              magic_shopify_key: Gt.merchant_key,
            })),
          n
        );
      }
      function _l(e) {
        try {
          vl.backdrop.style.background = e;
        } catch (e) {}
      }
      function vl(e) {
        if (((al = document.body), (il = document.head), (cl = al.style), e))
          return this.getEl(e), this.openRzp(e);
        this.getEl(), (this.time = bn());
      }
      vl.prototype = {
        getEl: function (e) {
          if (!this.el) {
        ...
        openRzp: function (e) {
          var n = et(this.el, { width: "100%", height: "100%" }),
            t = e.get("parent");
          t && (t = Lt(t));
          var r = t || vl.container;
          ll ||
            (ll = (function () {
              var e,
                n =
              ...
              try {
                ...
                Ta(e, { severity: Gr, unhandled: !1 });
              }
            })(r, t)),
            e !== this.rzp && ($n(n) !== r && Zn(r, n), (this.rzp = e)),
            (function (e) {
            ...
            t
              ? (Qn(n, "minHeight", "530px"), (this.embedded = !0))
              : (rt(Qn(r, "display", "block")),
                _l(e.get("theme.backdrop_color")),
                /^rzp_t/.test(e.get("key")) &&
                  vl.ribbon &&
                  (vl.ribbon.style.opacity = 1),
        ...
        makeMessage: function (e, n) {
          var t = this.rzp,
            ...
            o = {
              ...
              referer: Ir.props.referer || location.href,
              options: r,
        ...
        close: function () {
          _l(""),
            vl.ribbon && (vl.ribbon.style.opacity = 0),
            (function (e) {
              e && e.forEach(Yn);
              var n = fl();
              n && n.forEach(Un(il));
            })(this.$metas),
            (cl.overflow = pl.overflow),
            this.unbind(),
            ml && dl(0, pl.oldY),
            tl(),
            Ir.flush();
        ...
        bind: function () {
          ...
          if (!this.listeners) {
            ...
            var n = {};
            ml &&
              ((n.orientationchange = pl.orientationchange),
              this.rzp.get("parent") || (n.resize = pl.resize)),
              oe(n, function (n, t) {
        ...
        setMetaAndOverflow: function () {
          il &&
            ...
            this.$metas.forEach(Un(il)),
            (pl.overflow = cl.overflow),
            (cl.overflow = "hidden"),
            ml &&
              ((pl.oldY = i.g.pageYOffset),
              i.g.scrollTo(0, 0),
              pl.orientationchange.call(this)));
        },
        postMessage: function (e) {
          var n, t, r;
          e.id =
            (null === (n = this.rzp) || void 0 === n ? void 0 : n.id) || No();
          ...
          if (n) {
            ...
            if (
              ...
              (n = n.data),
                this["on" + t](n),
                ("dismiss" !== t && "fault" !== t) ||
                  Eo.track(t, { data: n, r: r, immediately: !0 });
            }
          }
        },
        onload: function (e) {
        ...
        onblur: function () {
          (this.isFocused = !1), pl.orientationchange.call(this);
        },
        onrender: function () {
          ll && (Yn(ll), (ll = null)), this.rzp.emit("render");
        },
        onevent: function (e) {
              ...
              window.gtag(
                ...
                (function (e) {
                  for (var n = 1; n < arguments.length; n++) {
                    var t = null != arguments[n] ? arguments[n] : {};
                    n % 2
                      ? ol(Object(t), !0).forEach(function (n) {
                          _(e, n, t[n]);
                        })
                      : Object.getOwnPropertyDescriptors
                      ? Object.defineProperties(
                      ...
                      : ol(Object(t)).forEach(function (n) {
                          Object.defineProperty(
                            e,
                            n,
                            Object.getOwnPropertyDescriptor(t, n)
        ...
        onsubmit: function (e) {
          rl({ event: Qc, category: Xc }), Ir.flush();
          var n = this.rzp;
          "wallet" === e.method &&
        ...
        oncomplete: function (e) {
          ...
          t && this.ongaevent({ event: Jc, category: Xc }),
            r && this.onfbaevent({ event: Jc, category: Xc }),
            this.close();
          var o = this.rzp,
            a = o.get("handler");
          Eo.track("checkout_success", { r: o, data: e, immediately: !0 }),
            un(a) &&
              setTimeout(function () {
                a.call(o, e);
              }, 200);
        ...
        onpaymenterror: function (e) {
          ...
          var n = this.rzp.get(),
            t = n.enable_ga_analytics,
            r = n.enable_fb_analytics;
          t && this.ongaevent({ event: qc, category: Xc }),
            r && this.onfbaevent({ event: qc, category: Xc });
          try {
            var o,
        ...
        onfault: function (e) {
          ...
          (this.rzp.get("redirect") || Ye) && t
            ? wt({ url: t, params: { error: e }, method: "POST" })
            : i.g.alert("Oops! Something went wrong.\n" + n),
            this.afterClose();
        },
        afterClose: function () {
          tl(), (vl.container.style.display = "none");
        },
        onflush: function (e) {
          Ir.flush(e);
        },
      ...
      var bl,
        Ol = "is_one_click_checkout_enabled_lite",
        wl = gn(oi);
      function xl(e) {
        return function n() {
          return bl ? e.call(this) : (setTimeout(n.bind(this), 99), this);
        };
      }
      !(function e() {
        (bl = document.body || document.getElementsByTagName("body")[0]) ||
          setTimeout(e, 99);
      })();
      var Sl,
        El = document.currentScript || (Sl = Nt("script"))[Sl.length - 1];
      function Pl(e) {
        var n = $n(El);
        xt({ form: n, data: Pt(e) }), (n.onsubmit = Uo), n.submit();
      }
      var kl, Rl;
      function Al() {
        var e = {};
        oe(El.attributes, function (n) {
        ...
        if (n && n.length > 0) {
          ...
          var t = oi(e);
          e.parent ||
            (So.TrackRender(yo.AUTOMATIC_CHECKOUT_OPEN, t),
            (function (e) {
              var n = $n(El);
              Zn(
                n,
                ...
                if (ln(r) && r && !i.callback_url) {
                  ...
                  try {
                    ...
                    i.callback_url = Va("checkout/onyx") + "?data=" + l;
                  } catch (e) {}
                }
                return e.open(), So.TrackBehav(yo.AUTOMATIC_CHECKOUT_CLICK), !1;
              };
            })(t));
        }
      }
      ...
      var Dl,
        ...
        Ml =
          ...
          null != Dl && Dl.id ? Dl.id : null);
      function Il(e) {
        if (Rl) Rl.openRzp(e);
        else {
          var n;
          (Rl = new vl(e)), (Xt.iframeReference = Rl.el), Xt.setId(Ir.id);
          var t = Rl.onmessage.bind(Rl);
      ...
      Qe().then(function (e) {
        ...
        (oi.triggerShopifyCheckoutBtnClickEvent = function () {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : "unknown",
      ...
      var Nl = wl.onNew;
      (wl.onNew = function (e, n) {
        "payment.error" === e && Ir(this, "event_paymenterror", location.href),
          un(Nl) && Nl.call(this, e, n);
      }),
        (wl.open = xl(function () {
          this.metadata ||
            ((this.metadata = { isBrave: jl, isPrivate: Tl }),
            Ml && (this.metadata.affordability_widget_fid = Ml)),
            (this.metadata.openedAt = Date.now());
          var e = (this.checkoutFrame = Il(this));
          So.setMeta(Ol, Oe() && !ye("order_id")), So.Track(yo.OPEN);
          try {
            ti.INVOKED({
              prefill: {
          ...
          return (
            ...
            "-new.js" === El.src.slice(-7) &&
              Ir(this, "oldscript", location.href),
            this
          );
        })),
        (wl.resume = function (e) {
      ...
      var Ll = xl(function () {
          So.setMeta(
            xo,
            (i.g.innerWidth && i.g.innerWidth < 485) || Ve || qe()
          ),
            Cl(),
            window.Intl ? (Rl = Il()) : So.Track(yo.INTL_MISSING),
            Xt.subscribe(yl, function (e) {
              var n = (e.data || {}).url,
                t = window.onbeforeunload;
              window.onbeforeunload = null;
              try {
                $t({ method: "GET", content: "", url: n });
              } catch (e) {}
              setTimeout(function () {
                Xt.sendMessage("".concat(yl, ":finished"), {
      ...
      (Ir.props.library = Bl),
        ...
        (Ia.handler = function (e) {
          if (yn(this, oi)) {
            ...
            n && wt({ url: n, params: e, method: "POST" });
          }
        }),
        (Ia.buttontext = "Pay Now"),
        (Ia.parent = null),
        (ui.parent = function (e) {
